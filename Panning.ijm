...
// v1.0 09/05/2020
// Generate a stack of a zommed window along a polyline ROI
// Optional output: stack of the original image with a moving zoom box, unscaled (can generate a large file), scale to the window width, or to the window height
